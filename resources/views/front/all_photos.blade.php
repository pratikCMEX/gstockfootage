 ...
 <main>
         ...
         <div class="container">
             ...
             <div class="row row-gap-4">
                 ...
                 <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12">
                     <div class="brand-posibility">
                         <div class="posibility-img">
                             <img width="100%" height="100%" src="imgs/anita-austvika-7VTKbHqli9c-unsplash.jpg"
                                 alt="">
                         </div>
                 ...
                 <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12">
                     <div class="brand-posibility">
                         <div class="posibility-img">
                             <img width="100%" height="100%" src="imgs/brianna-parks-j6vp8NJPHOI-unsplash.jpg"
                                 alt="">
                         </div>
                         <div class="posibilty-title">
                 ...
                 <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12">
                     <div class="brand-posibility">
                         <div class="posibility-img">
                             <img width="100%" height="100%" src="imgs/christopher-stites-M6b7Pm2u-ms-unsplash.jpg"
                                 alt="">
                         </div>
                         <div class="posibilty-title">
                             <h3>Photography</h3>
                 ...
                 <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12">
                     <div class="brand-posibility">
                         <div class="posibility-img">
                             <img width="100%" height="100%" src="imgs/daniel-miksha-9U645Y6gxEc-unsplash.jpg"
                                 alt="">
                         </div>
                         <div class="posibilty-title">
     ...
     <!-- trending today -->
     <section class="photo-trending-today">
         <div class="container">
             <div class="row">
                 <div class="col-12">
                     <div class="heading ">
             ...
             <div class="row mt-3 row-gap-3">
                 <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 col-12">
                     <div class="product-card">
                         ...
                         <a href="product-detail.html">
                             <img src="imgs/francesco-ungaro-97-blyf3IxE-unsplash.jpg" class="product-img" alt="">
                         </a>
                 ...
                 <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 col-12">
                     <div class="product-card">
                         ...
                         <a href="product-detail.html">
                             <img src="imgs/jivan-garcha-eqxjqXER9NY-unsplash.jpg" class="product-img" alt="">
                         </a>
                 ...
                 <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 col-12">
                     <div class="product-card">
                         ...
                         <a href="product-detail.html">
                             <img src="imgs/land-o-lakes-inc-1w3tO5F8HYY-unsplash.jpg" class="product-img" alt="">
                         </a>
                 ...
                 <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 col-12">
                     <div class="product-card">
                         ...
                         <a href="product-detail.html">
                             <img src="imgs/land-o-lakes-inc-BvZYHz9TeCk-unsplash.jpg" class="product-img" alt="">
                         </a>
