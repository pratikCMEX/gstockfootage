                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 col-12">
                        <div class="product-card">
                            ...
                            <a href="{{ route('product.detail', encrypt($photos->id)) }}">
                                <img src="{{ Storage::disk('s3')->url($photos->low_path) }}"
                            ...
                            <div class="p-3">
                                ...
                                <div class="price-btn">
                                    ...
                                    <a href="{{ route('product.detail', encrypt($photos->id)) }}" class="btn btn-orange">Add</a>
                                </div>
                                <div class="product-two-btn">
                                    <button class="btn  popular-icon-btn addFavorite"   data-Product-id="{{ $photos->id  }}" data-type="{{  $photos->type  }}"><svg xmlns="http://www.w3.org/2000/svg" width="16"
                                        ...
                                        Save</button>
                                    <button class="btn  popular-icon-btn"><svg xmlns="http://www.w3.org/2000/svg" width="16"
