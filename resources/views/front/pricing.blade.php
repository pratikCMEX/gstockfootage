             ...
             <div class="row g-4 justify-content-md-center">
                 <div class="col-lg-4 col-md-6">
                     <div class="pricing-card">
                         <h5>SD License</h5>
                         <p class="text-secondary">Perfect for web and social media</p>
                         <div class="price">$29 <span>/ clip</span></div>
                         <p class="text-secondary price-text">Up to 720p</p>

                         <button class="btn btn-orange w-100">Get Started</button>

                         <ul class="features">
                             <li>Standard Definition (720p)</li>
                             <li>Web & Social Media Use</li>
                         ...
                         <div class="subscription-card">
                             <div class="subscription-title">
                                 <div class="subscription-left">
                                     <h5>Monthly</h5>
                                     <p class="text-secondary">10 HD clips per month</p>
                                 </div>
                             </div>
                             <div class="subscribe-price">$199 <span>/ month</span></div>
                             <p class="text-secondary subscribe-price-text">$19.90 per clip</p>
             ...
             <div class="row justify-content-center row-gap-4">
                 <div class="col-12 text-center">
                     <div class="heading">
                         ...
                         <p>All purchases include perpetual, worldwide licenses. Choose the license that fits your project's distribution needs.</p>
                     </div>
                 </div>
                 <div class="col-lg-6">
