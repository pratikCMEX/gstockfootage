        ...
        <div class="footer-flex">
            ...
            <div class="footer-box footer-brand">
                ...
                <div class="social-links">
                    <a href="{{ $social_links->facebook_link ? $social_links->facebook_link : '' }}"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18"
                            viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                            stroke-linecap="round" stroke-linejoin="round"
                            class="lucide lucide-facebook h-4 w-4 text-muted-foreground">
                            <path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"></path>
                        </svg></a>
                    <a href="{{ $social_links->twitter_link ? $social_links->twitter_link :'' }}">
                    ...
                    <a href="{{ $social_links->instagram_link  ? $social_links->instagram_link :''}}"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18"
                            viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                            stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <a href="{{ $social_links->linkedin_link ?  $social_links->linkedin_link: ''}}"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18"
                            viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                            stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <a href="{{ $social_links->youtube_link ? $social_links->youtube_link :'' }}"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18"
                            viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                            stroke-linecap="round" stroke-linejoin="round"
