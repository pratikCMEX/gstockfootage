                        ...
                        <form action="{{ route('admin.affiliates.update', $affiliate->id) }}" method="POST"
                            ...
                            <div class="affiliate-form-flex">
                                ...
                                <div class="mb-3 w-100">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" value="{{ $affiliate->referral_code }}"
                                            readonly>
                            ...
                            <div class="affiliate-form-flex">
                                <div class="mb-3 w-100">
                                    ...
                                    <select name="commission_type" id="commission_type" class="form-select"
                                        ...
                                        <option value="percentage" {{  $affiliate->commission_type == 'percentage' ? 'selected' : '' }}>
                                            Percentage</option>
                                    </select>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="address" placeholder="Enter address" rows="4"
                                    class="form-control affiliate-textarea  @error('address') is-invalid @enderror">{{ old('address', $affiliate->affiliateUser->address ?? '') }}</textarea>
                                @error('address')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
