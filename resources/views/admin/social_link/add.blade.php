    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-body">
                ...
                <div class="card">
                    <div class="card-body">
                        <form name="social_links_form" id="social_links_form" method="POST"
                            action="{{ route('admin.social_links_store') }}">
                            @csrf
                            @if ($social_links)
                                ...
                                <div class="col-sm-6 col-12 mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="url" name="instagram_link" class="form-control"
                                            id="instagram_link" value="{{ $social_links->instagram_link ?? '' }}"
                                ...
                                <div class="col-sm-6 col-12 mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="url" name="facebook_link" class="form-control"
                                            id="facebook_link" value="{{ $social_links->facebook_link ?? '' }}"
                                ...
                                <div class="col-sm-6 col-12 mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="url" name="linkedin_link" class="form-control"
                                            id="linkedin_link" value="{{ $social_links->linkedin_link ?? '' }}"
