                        ...
                        <tbody>
                            @forelse ($order->order_details ?? [] as $index => $item)
                                <tr>
                                    ...
                                    <td>
                                        <div class="product-info-cell">
                                            @if(isset($item->product))
                                                ...
                                                @endif
                                                <div>
                                                    <div class="product-title">{{ $item->product->title ?? 'N/A' }}</div>
                                                    <div class="product-type">{{ ucfirst($item->product->type ?? '') }}</div>
                                                </div>
                                            @else
                                    ...
                                    <td>
                                        <span class="status-badge {{ $item->product->type === 'image' ? 'processing' : 'pending' }}">
                ...
                <div class="card-body-custom">
                    <div class="info-grid">
                        <div class="info-item">
                            ...
                            <div class="info-value">{{ $order->user->first_name.' '.$order->user->last_name ?? 'N/A' }}</div>
                        </div>
                        <div class="info-item">
                            <label>Email</label>
