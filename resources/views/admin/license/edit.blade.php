                        ...
                        <form id="license_form" method="POST" action="{{ route('admin.license_update') }}"
                            ...
                            <div class="row">
                                <div class="col-sm-6 col-12 mb-3">
                                    ...
                                    <label for="exampleInputEmail1" class="form-label">License Name</label><label
                                ...
                                <div class="col-sm-6 col-12 mb-3">
                                    <label for="exampleInputEmail1" class="form-label">Title</label><label
                                        class="text-danger">*</label>
                                ...
                                <div class="col-sm-6 col-12 mb-3">
                                    <label for="product_quality" class="form-label">Product Quantity</label><label
                                        class="text-danger">*</label>
                                ...
                                <div class="col-sm-6 col-12 mb-3">
                                    <label for="exampleInputEmail1" class="form-label">Quality</label><label
                                        class="text-danger">*</label>
                                ...
                                <div class="col-sm-6 col-12 mb-3">
                                    <label for="exampleInputEmail1" class="form-label">Plan Price</label><label
                                        class="text-danger">*</label>
