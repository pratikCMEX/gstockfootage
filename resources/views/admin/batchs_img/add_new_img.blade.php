                            ...
                            <div class="create-upload-head">
                                <div class="select-img">
                                    ...
                                    <div class="delete-submit">
                                        <button type="button" class="btn btn-light">Delete <span style="margin-left: 10px; padding: 4px; font-size: 12px; background-color: black; color: white; border-radius: 20px;"> 34</span></button>
                                        <button type="button" class="btn select-submit-btn"><i class="fa-solid fa-paper-plane"></i> Submit <span>0</span></button>
                                    </div>
                                </div>
                                <div class="two-btns">
                                    <button type="button" class="upload-btn btn btn-primary batch-create"><i class="ti ti-plus"></i> Upload</button>
                                    <div class="upload-from-device">
                                        <div class="upload-main-content">
                                            <div class="upload-from-device-head">
                                                <button type="button" class="btn upload-close-btn"><i class="fa-solid fa-xmark"></i> Upload</button>
                                        ...
                                        ">Drag and drop your files here or upload from <span class="upload-span">
                                                ...
                                                <div class="upload-device-list-detail text-start">
                                                    <ul>
                                                        ...
                                                        <li>Supported browsers : Chrome , firefox ,IE10+ , safari 6+</li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="img-responsive-head">
                                <div class="image-range">
                                    ...
                                    <div class="range-container">
                                        <input type="range" min="1" max="6" value="0" class="slider">
                                    </div>
        ...
        <div class="modal-content">
            <form action="">
                <div class="modal-header  m-auto ">
                    <h5 class="modal-title" id="renameModalLabel" style="font-size: 16px;">Enter a time from your video to set a thumbnail frame </h5>
                </div>
