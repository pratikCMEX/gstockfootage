<div class="body-wrapper-inner">
    ...
    <div class="container-fluid">
        <div class="card">
            <div class="car<div class="body-wrapper-inner">
                <!-- Modal Button -->
                {{-- @php
        dd(request()->submission_type);
    @endphp --}}
                                                ...
                                                <div class="create-batch-head">
                                                    <div class="create-batch-btn">
                                                        ...
                                                        <div class="modal fade " id="exampleModal" tabindex="-1"
                                                            ...
                                                            <div class="create-batch-filter">
                                                                ...
                                                                <button
                                                                    class="btn btn-orange search-desktop search-filter-openbtn"
                                                                    id="search_filter">
                                                                ...
                                                                <button class="btn search-mobile search-filter-openbtn"
                                                                    ...
                                                                    <i
                                                                        class="fa-solid fa-magnifying-glass me-3"></i></button>
                                                        ...
                                                        @else
                                                            <p class="counting-show-batch"> Show
                                                                {{ $batches->firstItem() }} to
                                                                {{ $batches->lastItem() }} of {{ $batches->total() }}
                                                                Batches
                                                            </p>
                                                        @endif
                                                        {{-- {{ dd($batch_list) }} --}}
                                                            ...
                                                            <div class="batch-content">
                                                                <div class="batch-content-title">
                                                                    ...
                                                                    <div class="content-dropdown">
                                                                        <button
                                                                            class="btn  text-start dot-dropdown dropdown-toggle"
                                                                        ...
                                                                        <ul class="dropdown-menu more-detail-menu">
                                                                            <li>
                                                                                <button type="button"
                                                                                    ...
                                                                                    <i
                                                                                        class="fa-solid fa-pencil me-3"></i>
                                                                                    Rename
                                                                                </button>
                                                                            </li>
                                                    ...
                                                    video</label> --}}
                                                                    @if ($list['submission_type'] == 'video')
                                                                        <label for=""> <i
                                                                                class="fa-solid fa-video"></i> Gstock
                                                                            creative
                                                                            video</label>
                                                                    @else
                                                                        <label for=""> <i
                                                                ...
                                                                <div class="batch-content-detail">
                                                                    <a class="batch-content-img"
                                                                        ...
                                                                        <div
                                                                            class="batch-collect-imgs {{ $class }}">
                                                            ...
                                                            <p class="circel-count"><span>0</span> Not Submitted</p>
                                                                    ...
                                                                    <div class="more-detail">
                                                                        <button class="btn more-detail-btn "
                                                                            type="button">
                                                                            <i class="fa-solid fa-angle-down"></i>More
                                                                            Detail
                                                                        </button>
                                                                ...
                                                                <div class="batch-content-table-details">
                                                                    <table>
                                                                        <thead>
                                                                            <th>
                                                                                <tr>
                                                                                    <td class="table-heading">File ID
                                                                                    </td>
                                                                                    <td class="table-heading">File Name
                                                                                    </td>
                                                                                    <td class="table-heading">Title
                                                                                    </td>
                                                                                    <td class="table-heading">Status
                                                                                    </td>
                                                                                </tr>
                                                                            </th>
                                                                        </thead>
                                                    ...
                                                    <form id="filterForm" action="" method="post">
                                                        ...
                                                        <div class="search-filter">
                                                            <div class="search-filter-child-content"
                                                                        ...
                                                                        <div class="date-range">
                                                                            ...
                                                                            <div class="date-inputs">
                                                                                <div class="date-box">
                                                                                    ...
                                                                                    <span
                                                                                        class="date-format">MM/DD/YYYY</span>
                                                                                </div>
                                                                                ...
                                                                                <div class="date-box">
                                                                                    <span class="date-title">End date
                                                                                        *</span>
                                                                                    <input type="date"
                                                                                        name="end_date"
                        ...
                        <div class="modal-content">
                            <form action="">
                                ...
                                <div class="modal-body">
                                    ...
                                    <input type="text" name="branch_name" id="rename_batch_name"
                                        class="form-control batch-inp" placeholder="Enter new name">
                                </div>
                ...
                <div class="modal fade" id="deleteModal" tabindex="-1" aria-labelledby="renameModalLabel"
                    aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered text-center">
                        <div class="modal-content">
                            ...
                            <div class="modal-body text-center">
                                <div class="delete-icon  m-auto"><i class="fa-solid fa-triangle-exclamation "></i>
                                </div>
                                <p style="font-size: 16px; color:gray; margin-top:15px;">If you delete the link will be
                                    gone forever.
                            ...
                            <div class="modal-footer text-center m-auto">
                                ...
                                <button type="button" class="btn btn-danger delete_branch"
                                        ...
                                        <div class="create-batch-btn">
                                            ...
                                            @foreach ($batch_list as $list)
                                                <div class="batch-content">
                                                    ...
                                                    video</label> --}}
                                                        @if ($list['submission_type'] == 'video')
                                                            <label for=""> <i class="fa-solid fa-video"></i>
                                                                Gstock
                                                                creative
                                                                video</label>
                                                        @else
                                                    ...
                                                    <div class="batch-content-detail">
                                                        ...
                                                        <div class="batch-content-create">
                                                            <div class="batch-content-create-text">
                                                                <p class="batchid">BatchID {{ $list['batch_code'] }}
                                                                </p>
                                                                {{-- <p class="batchcreated">Created : Feb 16,2026</p> --}}
                                                                <div>
                                                                    <p class="batchcreated">
                                                        ...
                                                        <label class="form-check-label" for="checkDefault1">
                                                            Gstock Creative illustration
                                                                ...
                                                                <li>
                                                                    <div class="form-check">
                                                                        <input class="form-check-input"
                                                                            type="checkbox" id="checkDefault2"
                                                                ...
                                                                <li>
                                                                    <div class="form-check">
                                                                        <input class="form-check-input"
                                                                            type="checkbox" id="checkDefault3"
        ...
        <div class="modal-dialog modal-dialog-centered text-center">
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    ...
                    <p style="font-size: 16px; color:gray; margin-top:15px;">If you delete the link will be gone
                        forever.
                        Are you sure you want to procced</p>
                </div>
