...
class CollectionDataTable extends DataTable
{
     ...
     *
     * @param QueryBuilder<Collection> $query Results from query() method.
     */
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        return datatables()
            ...
            ->addColumn('image', function ($row) {
                return '<img src="' . asset('uploads/images/collection/' . $row->image) . '" 
                         class="preview-image" 
                         data-src="' . asset('uploads/images/collection/' . $row->image) . '" 
            ...
            ->addColumn('actions', function ($row) {
                ...
                $updateButton = '
            <a href="' . route('admin.collection_edit', ['id' => encrypt($row->id)]) . '"
               class="btn btn-primary btn-sm me-1 manage-customer-edit">
                ...
                $deleteButton = '
            <button type="button" class="btn btn-danger btn-sm deleteCollection"  data-id="' . encrypt($row->id) . '">
     ...
     */
    public function query(Collection $model, Request $request): QueryBuilder
    {
        $columns = [
            0 => 'id',
            1 => 'name',
        ...
        return Collection::query()->orderBy($column, $direction);
    }
