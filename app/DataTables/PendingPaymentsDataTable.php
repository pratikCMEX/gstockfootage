...
class PendingPaymentsDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->filterColumn('commission_amount', function ($query, $keyword) {
                $query->where('affiliate_referrals.commission_amount', 'like', "%{$keyword}%");
            })
    ...
    public function query(AffiliateReferral $model): QueryBuilder
    {
        ...
        //  Only pending commissions for current affiliate
    ...
    {
        return $this->builder()
            ->setTableId('pendingpayments-table')
    ...
    {
        return 'PendingPayments_' . date('YmdHis');
    }
}