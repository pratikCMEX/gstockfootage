...
class ContactUsDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('actions', function ($row) {
                ...
                $deleteButton = '
            <button type="button" class="btn btn-danger btn-sm deleteContactUs me-2"  data-id="' . encrypt($row->id) . '">
           ...
           class=" btn btn-danger   btn-sm  viewMessage" 
          ...
          <i class="fa-regular fa-eye"></i>
                ...
                return '<div class="d-flex">' . $deleteButton .$eyeIcon. '</div>';
            })
     ...
     *
     * @return QueryBuilder<ContactMessage>
     */
