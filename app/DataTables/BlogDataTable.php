    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('image', function ($blog) {
                if ($blog->image) {
                    return '<img src="' . asset('uploads/images/blogs/' . $blog->image) . '" 
            ...
            ->addColumn('action', function ($blog) {
                ...
                $updateButton = '
            <a href="' . route('admin.blog_edit', ['id' => encrypt($blog->id)]) . '"
               class="btn btn-primary btn-sm me-1 manage-customer-edit">
                ...
                $deleteButton = '
            <button type="button" class="btn btn-danger btn-sm deleteBlog"  data-id="' . encrypt($blog->id) . '">
            ...
            ->setRowId('id')
            ->rawColumns(['action', 'image', 'description','publish_date','checkbox']);
    }
