...
class LicenseDataTable extends DataTable
{
     ...
     *
     * @param QueryBuilder<License> $query Results from query() method.
     */
    ...
    ';
            ...
            ->addColumn('action', function ($row) {
                ...
                $updateButton = '
            <a href="' . route('admin.license_edit', ['id' => encrypt($row->id)]) . '"
               class="btn btn-primary btn-sm me-1 manage-customer-edit">
                ...
                $deleteButton = '
            <button type="button" class="btn btn-danger btn-sm deleteLicense"  data-id="' . encrypt($row->id) . '">
