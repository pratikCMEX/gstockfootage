    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('profile_image', function ($row) {
                ...
                if (!empty($row->profile_image) && file_exists(public_path('uploads/images/testimonials/' . $row->image))) {
            ...
            ->addColumn('actions', function ($row) {
                ...
                $updateButton = '
            <a href="' . route('admin.testimonials_edit', ['id' => encrypt($row->id)]) . '"
               class="btn btn-primary btn-sm me-1 manage-customer-edit">
                ...
                $deleteButton = '
            <button type="button" class="btn btn-danger btn-sm deleteTestimonial"  data-id="' . encrypt($row->id) . '">
