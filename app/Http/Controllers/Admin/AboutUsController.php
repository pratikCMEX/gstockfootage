    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if ($id) {
                ...
                $aboutUs->update($data);
                return redirect()->route('admin.about_us')->with('msg_success', 'About Us updated successfully!');
                ...
                AboutUs::create($data);
                return redirect()->route('admin.about_us')->with('msg_success', 'About Us created successfully!');
            }
        } catch (\Exception $e) {
